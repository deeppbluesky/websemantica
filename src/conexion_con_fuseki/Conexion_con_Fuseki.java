...
public class Conexion_con_Fuseki {
    ...
    public static void main(String[] args) {
        ...
        //servidor Fuseki
        String fuseki = "http://192.168.0.5:3030/prueba";
        //Se manda llamar el método de consulta
        ejecutarConsulta(
                fuseki,                
                "PREFIX onto: <http://www.co-ode.org/ontologies/pizza/2005/10/18/futbol.owl#> "
                + "PREFIX ins: <http://www.co-ode.org/ontologies/pizza/2005/10/18/futbol.owl#>  "
